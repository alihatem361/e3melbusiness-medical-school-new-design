...
(function ($) {
  ...
  var retinaLogos = function () {
    ...
    if (retina) {
      ...
      //   $(".logo-bottom")
      //     .find("img")
      //     .attr({ src: "./assets/image/Logolight@2x.png" });
  ...
  var flatAccordion = function () {
    ...
    $(".box-faq .item-faq.active .title-heading-faq")
      .siblings(".content-item-faq")
      .show();
